...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<User?> _loadUserProfile() async {
    ...
    if (userEmail != null) {
      //   return APIService.getUserByEmail(userEmail);
      // } else {
      //   return null;
      // }
      try {
        User user = await APIService.getUserByEmail(userEmail);
      ...
      print('No user email found'); // Debug log
      return null;
    }
  }
